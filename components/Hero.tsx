...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py20 xl:flex-row">
      ...
      <section className="relative z-20 flex flex-col xl:w-1/2">
        <Image
          src="/camp.svg"
          alt="camp"
          width={50}
        ...
        />
        <h1 className="bold-52 lg:bold-88">Gandario Camp Area</h1>
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          We want to be on each of your journeys seeking the satisfaction of
          seeing the incorruptible beauty of nature. We can help you on an
          adventure around the world in just one app
        </p>
        <section className="my-11 flex flex-wrap gap-5">
      ...
      <section className="relative flex flex-1 items-start">
        <section className="relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <section className="flex flex-col">
            <section className="flexBetween">
              <p className="regular-16 text-gray-20">Location</p>
              <Image src="/close.svg" alt="close" width={24} height={24} />
            </section>
            <p className="bold-20 text-white">Bergondo</p>
          </section>
          <section className="flexBetween">
            <section className="flex flex-col">
